        ...
        <SheetFooter>
          <div className="flex w-full items-center justify-between">
            <div className="flex gap-2">
              ...
              <Button onClick={() => { const s = useSettings.getState(); try { window.localStorage.setItem('wb_settings', JSON.stringify({ save: s.save, tools: s.tools, performance: s.performance })); } catch (e) {} }}>Save</Button>
            </div>
          </div>
        </SheetFooter>
      </SheetContent>
